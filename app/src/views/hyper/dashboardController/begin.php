                ...
                <div class="row h-100">
                    <div class="col-5 p-0" id="streamGraph">
                        <div class="container-fluid pe-0 ps-0">
                            <div class="row p-0 mb-1 ms-2 mt-1 me-2" id="streamMetrics" style="display:none; background-color:#939DA3">
                    ...
                    <div class="col-4 p-0">
                        <div class="container-fluid pe-0 ps-0">
                            <div class="row p-0 mb-1 ms-0 mt-1 me-2 float-left" id="globalIntensity" style="display:none; background-color:#939DA3">
                                <p class="m-0 fw-bold text-center text-light">
                                    Intensidade Global
                                </p>
                            </div>
                            ...
                            <div class="row p-0 mb-1 ms-0 mt-0 me-2" id="trackerMap" style="display:none; background-color:#939DA3">
                                <p class="m-0 fw-bold text-center text-light">
                    ...
                    <div class="col-3 p-0">
                        <div class="container-fluid pe-0 ps-0">
                            <div class="row p-0 mb-1 ms-2 mt-1 me-2" id="statsChart" style="display:none; background-color:#939DA3">
                                <p class="m-0 fw-bold text-center text-light">
