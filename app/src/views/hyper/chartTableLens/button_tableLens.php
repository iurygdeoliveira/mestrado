<div class="d-flex justify-content-center mt-2">
    <button type="button" class="btn btn-light btn-sm col-12" id="search_rides" onclick="verPedaladas()" data-bs-target="#modalTableLens" data-bs-toggle="modal" disabled title="See Table Lens">
